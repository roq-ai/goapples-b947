...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['program-manager', 'video-editor', 'graphic-designer', 'content-reviewer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Workflow', path: '/workflows', entity: 'workflow', service: AccessServiceEnum.PROJECT, icon: FiActivity },
