...
function WorkflowListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('workflow', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/workflows/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('workflow', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/workflows/create`} passHref legacyBehavior>
